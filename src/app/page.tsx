...
{/* className="mx-auto max-w-screen-lg" */}
  <div>
    <button className="fixed top-4 right-4 bg-white text-blue px-8 py-2 rounded-full cursor-pointer">
...
<button className=" bg-white text-blue px-5 py-5 rounded-full cursor-pointer">
    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
